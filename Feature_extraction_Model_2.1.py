# FEATURE EXTRACTION MODEL 2.1

# WITH THIS SCRIPT, A BAG OF WORDS MODEL CAN BE CREATED CONSISTING OF NAMED ENTITIES, WITH THEIR FREQUENCY COUNTS
# FOR THIS, THE NL_CORE_NEWS_MD MODEL (SPACY) IS EMPLOYED. IT RETURNS A BOW-REPRESENTATION FOR A SINGLE TEXT.
# MOREOVER, MANUAL NAMED ENTITY EXTRACTION IS DONE, EXTRACTING MENTIONED ARTICLES, JUDICIAL INSTITUTES, AND ECLI-NUMBERS (i.e., LEGAL REFERENCES)
...
#note, the dataframe is expected to have a "full_text" column, containing the actual texts, and a "creator" column, refering to the judicial institute that created the case (e.g.,"Gerechtshof Den Haag") 
file_path_2 = "PATH_TO_DATA_CONTAINING_THE TEXTS"
