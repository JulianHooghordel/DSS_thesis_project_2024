# PART 2 OF FEATURE EXTRACTION MODEL 2.2

# WITH THIS SCRIPT, A BAG OF WORDS MODEL CAN BE CREATED CONSISTING OF LEGAL REFERENCES FOUND IN EACH TEXT, WITH THEIR FREQUENCY COUNTS
# FOR THIS, THE ROBBERT-V2-DUTCH-NER MODEL IS EMPLOYED. IT RETURNS A BOW-REPRESENTATION FOR A SINGLE TEXT.
# HERE, THE ENTITITES ARE NOT STORED IN A SINGLE STRING, AS OPPOSED TO THE ENTITIES EXTRACTED IN PART 1 OF MODEL 2.2
